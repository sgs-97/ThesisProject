...
function show_help() {
    echo "Description:"
    echo "  This script helps automatically homogenize the naming of laps and logs file names in experiment directories."
    echo
    echo "Usage: path/to/$(basename $0) [args] [options]" # Keep as it is
    echo
    echo "Arguments:"
    echo "  <dir>              Directory of logs and annotation (laps) data"
    echo
    echo "Options:"
...
function main() {
    ...
    echo "- [START] Homogenizing directory: $dir. Naming laps and logs files to 'laps.txt' and 'adb_log_0.log' respectively (if they don't exist as laps.txt and adb_logs_*.log).\n"
