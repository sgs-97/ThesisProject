...
function show_help() {
    echo "Description:"
    echo "  (Wrapper) Run hmd_umount_lap_to_sleep_lap_durations.sh on the specified directory containing subdirectories with log and annotation (laps) data after being preprocessed."
    echo
...
function main() {
    ...
    for sub_dir in "$dir"/*/; do
        ...
        $SCRIPT_DIR/hmd_umount_lap_to_sleep_lap_durations.sh "$sub_dir"
    done
