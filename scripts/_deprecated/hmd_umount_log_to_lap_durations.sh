...
function show_help() {
    echo "Description:"
    echo "  Run hmd_umount_log_to_lap_durations.py on the specified directory containing log and annotation (laps) data after being preprocessed."
    echo
...
function main() {
    ...
    echo "Generating HMD umount log to lap durations for directory: $dir"
    ...
    python3 "$SCRIPT_DIR"/../analyze/hmd_umount_log_to_lap_durations.py "$dir"
