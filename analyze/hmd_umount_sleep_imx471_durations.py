...
def read_imx471_activations_intervals_file(exp_dir):
    """
    Reads the imx471 activations file from the experiment directory.
    """
...
def get_imx471_last_start_stop_times(imx471_activations_intervals):
    """
    Extracts the last imx471 activation start and stop times from the intervals using pandas.
    """
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Extracts the durations between HMD unmount, imx471 activation start, and HMD sleep times from an experiment directory.')
    ...
    # Write to file (hmd_umount_sleep_imx471_durations.csv)
