...
if __name__ == '__main__':
    ...
    umount_pt_start_duration = abs(pd.Timestamp(pt_start_time) - pd.Timestamp(hmd_umount_times)).total_seconds() if hmd_umount_times else None
    pt_stop_sleep_duration = abs(pd.Timestamp(pt_stop_time) - pd.Timestamp(hmd_sleep_times)).total_seconds() if hmd_sleep_times else None
